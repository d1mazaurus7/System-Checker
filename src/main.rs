...
fn main() {
    loop {
        println!("\n[--- System Checker ---]");
        println!(
            "Hello! Hi! I'll check your system, display logs, and information about your PC.\n Select an option: "
        );
        println!("1. Show date");
        ...
        println!("6. Clean system cache");
        println!("7. Check for updates");
        println!("8. Clean up unnecessary dependencies");
        println!("q. Quit");
        print!("> ");
        ...
        match choice {
            ...
            "6" => {
                let cache = Command::new("sh")
                    .args(&["-c", "rm -rf ~/.cache/*"])
                    .status()
                    .expect("Failed to clear user cache...");
            }
            ...
            "8" => {
                let _ = Command::new("sudo")
                    .args(&["rm", "-rf", "/var/cache/pacman/pkg/download-*"])
                    .status();
            ...
            _ => {
                println!("Failed input. Try again");
            }
        }
    }
}
